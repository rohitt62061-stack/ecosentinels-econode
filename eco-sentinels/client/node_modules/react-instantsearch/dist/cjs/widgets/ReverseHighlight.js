...
function ReverseHighlight(_0) {
    ...
    var parts = properties.map(function(singleValue) {
        return (0, _utils.getHighlightedParts)((0, _utils.unescape)(singleValue.value || '')).map(function(_0) {
    ...
    return /*#__PURE__*/ _react.default.createElement(_ReverseHighlight.ReverseHighlight, _object_spread_props._(_object_spread._({}, props), {
        parts: parts,
