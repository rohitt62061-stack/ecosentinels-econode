...
var _connectLookingSimilar = /*#__PURE__*/ _interop_require_default._(require("../../connectors/looking-similar/connectLookingSimilar"));
...
function createRenderer(param) {
    ...
    return function(param, isFirstRendering) {
        ...
        (0, _preact.render)(/*#__PURE__*/ (0, _preact.h)(LookingSimilar, {
            items: items,
...
var _default = function lookingSimilar(widgetParams) {
