...
var _connectTrendingItems = /*#__PURE__*/ _interop_require_default._(require("../../connectors/trending-items/connectTrendingItems"));
...
function createRenderer(param) {
    ...
    return function renderer(param, isFirstRendering) {
        ...
        (0, _preact.render)(/*#__PURE__*/ (0, _preact.h)(TrendingItems, {
            items: items,
            sendEvent: sendEvent,
...
var _default = function trendingItems(widgetParams) {
