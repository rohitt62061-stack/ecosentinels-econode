...
var _connectFrequentlyBoughtTogether = /*#__PURE__*/ _interop_require_default._(require("../../connectors/frequently-bought-together/connectFrequentlyBoughtTogether"));
...
var renderer = function renderer(param) {
    ...
    return function(param, isFirstRendering) {
        ...
        (0, _preact.render)(/*#__PURE__*/ (0, _preact.h)(FrequentlyBoughtTogether, {
            items: items,
...
var _default = function frequentlyBoughtTogether(widgetParams) {
