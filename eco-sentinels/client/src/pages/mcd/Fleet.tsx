...
export default function Fleet() {
  ...
  // 1. Fetch Wards
  const { data: wardsData } = useSupabaseQuery<any[]>(
    async () => {
  ...
  // 2. Fetch Bins
  const { data: initialBins, loading: loadingBins, setData: setBinsData } = useSupabaseQuery<BinReading[]>(
    async () => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-[var(--bg-secondary)]/50 border border-[var(--border)] px-6 py-4 rounded-xl flex items-center justify-between">
            <div>
              ...
              {loadingBins ? <div className="h-9 w-12 shimmer rounded mt-1" /> : <h2 className="text-3xl font-black text-[var(--text-primary)] mt-1">{stats.total}</h2>}
            </div>
          ...
          <div className="bg-[var(--bg-secondary)]/50 border border-[var(--border)] px-6 py-4 rounded-xl flex items-center justify-between">
            <div>
              ...
              {loadingBins ? <div className="h-9 w-12 shimmer rounded mt-1" /> : <h2 className="text-3xl font-black text-rose-500 mt-1">{stats.needsCollection}</h2>}
            </div>
          ...
          <div className="bg-[var(--bg-secondary)]/50 border border-[var(--border)] px-6 py-4 rounded-xl flex items-center justify-between">
            <div>
              ...
              {loadingBins ? <div className="h-9 w-12 shimmer rounded mt-1" /> : <h2 className="text-3xl font-black text-emerald-400 mt-1">{stats.avgFill}%</h2>}
            </div>
