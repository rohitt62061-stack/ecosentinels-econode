...
export default function Reports() {
  ...
  return (
    <McdLayout>
      <div className="p-6 bg-[var(--bg-primary)] min-h-full text-[var(--text-primary)] flex flex-col gap-6 overflow-y-auto print:bg-white print:text-black transition-colors duration-300">
        ...
        {/* Modal AI Report */}
        {showModal && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[999] flex items-center justify-center p-4 print:relative print:p-0 print:bg-white transition-opacity">
            <div className="bg-[var(--bg-secondary)] border border-[var(--border)] rounded-2xl w-full max-w-xl p-6 flex flex-col gap-4 max-h-[80vh] overflow-y-auto shadow-2xl print:shadow-none print:border-none print:max-w-full print:max-h-none">
               ...
               {generating ? (
                  ...
                  <div className="prose prose-invert text-sm leading-relaxed text-[var(--text-secondary)] print:text-black print:prose-black">
                     {aiReport.split('\n').map((line, i) => (
