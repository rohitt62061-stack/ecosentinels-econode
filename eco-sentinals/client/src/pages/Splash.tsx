...
export default function Splash() {
  ...
  return (
    <div className="fixed inset-0 bg-[var(--bg-primary)] flex flex-col items-center justify-center text-[var(--text-primary)] overflow-hidden transition-colors duration-500">
      <style>{`
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full blur-[120px] opacity-10 pointer-events-none"
           style={{ background: 'linear-gradient(145deg, var(--bg-tertiary), var(--accent))' }}>
      </div>
      ...
      <div className="relative flex flex-col items-center gap-12 text-center px-6">
        ...
        <div className="flex flex-col gap-4 animate-editorial-fade" style={{ animationDelay: '0.4s' }}>
          <h1 
            className="text-5xl md:text-7xl font-bold tracking-tight text-[var(--accent)]"
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="w-12 h-[1px] bg-[var(--accent)] opacity-20 mx-auto mt-2"></div>
          </div>
        </div>
        ...
        <div className="mt-8 flex flex-col items-center gap-3 animate-editorial-fade opacity-0" style={{ animationDelay: '1s' }}>
          ...
          <div className="w-48 h-[2px] bg-[var(--border)] overflow-hidden">
            <div className="h-full bg-[var(--accent)] w-1/3 animate-[loading_2s_infinite_ease-in-out]"></div>
          </div>
        </div>
      </div>
